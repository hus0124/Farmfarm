...
<div class="row">
 <div class="col-lg-12">
  <div class="panel panel-default">
   ...
   <div class="panel-heading">정보 보기/수정</div>
      <!-- /.panel-heading -->
    <div class="panel-body">
	 ...
	 <form role = "form" action = "/user/infochange1" method = "get">
	  ...
	  <div class="form-group">
       ...
       <button type="submit" class="btn btn-warning" style = "width:145px;" name = "choice" value = "4">변경하기</button>
	  </div>
      ...
      <div class = "form-group">
	   <a href="/user/leave"><button class = "btn btn-danger" style = "width:145px;">회원 탈퇴하기</button></a>
	  </div>	  
